...
| Takumi Guard | script_based (registry プロキシ設定配布) | EA スクリプト (適用ユーザ数) | — / 配信手順は [docs/jamf-deploy-takumi-guard.md](docs/jamf-deploy-takumi-guard.md) |
...
- [docs/jamf-deploy-takumi-guard.md](docs/jamf-deploy-takumi-guard.md) — Takumi Guard (script_based) の Jamf Pro 配信手順
